	...
	cout << ("\n\n******************* Saida de Dados ********************* \n\n");
		...
		{        	
	     cout << "\n B  [" << i + 1 << "] = " << vetor1[i] << "\n";
        	...
        	vetor2[1] = ((1/vetor[5])*(vetor1[1] - (vetor[4]*vetor2[0]) - (vetor[6]*b3) - (vetor[7]*b4)));
        	vetor2[2] = ((1/vetor[10])*(vetor1[2] - (vetor[8]*vetor2[0]) - (vetor[9]*vetor2[1]) - (vetor[11]*b4)));
        	vetor2[3] = ((1/vetor[15])*(vetor1[3] - (vetor[12]*vetor2[0]) - (vetor[13]*vetor2[1]) - (vetor[14]*vetor2[2])));
